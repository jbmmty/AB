	...
	protected function render() {
		...
		<div class="ot-testimonials-2 slider__style-nav-2 <?php echo $settings['version_style']; ?>">						
			...
			<div <?php echo $this->get_render_attribute_string( 'slides' ); ?> <?php if( is_rtl() ){ echo'dir="rtl"'; }?> data-item-slider="ot_slider_<?php echo esc_attr( $this->get_id() ); ?>">
				...
				<?php if( $arrows ){ ?>
				<!-- Add Arrows -->
				<div class="octf-swiper-button-next" data-slider="ot_slider_<?php echo esc_attr( $this->get_id() ); ?>">
					<span>
				...
				<div class="octf-swiper-button-prev" data-slider="ot_slider_<?php echo esc_attr( $this->get_id() ); ?>">
					<span>
						<?php if ( $is_new || $migrated ) :
							Icons_Manager::render_icon( $settings['nav_icon_font'], [ 'aria-hidden' => 'true' ] );
						else : ?>
				...
				<?php if( $dots ){ ?>
				<!-- Add Dots -->
				<div class="octf-swiper-pagination-2" data-slider="ot_slider_<?php echo esc_attr( $this->get_id() ); ?>"></div>
				<?php } ?>
			</div>				
	    </div>

...
class Theratio_Testimonials extends Widget_Base{
	...
	protected function render() {
		...
		$this->add_render_attribute(
			'slides', [
				'class'               => ['testimonial-inner ot-testimonials-slider-s1 swiper swiper-container'],
		...
		<div class="ot-testimonials <?php echo $settings['version_style']; ?>">						
			...
			<div <?php echo $this->get_render_attribute_string( 'slides' ); ?> <?php if( is_rtl() ){ echo'dir="rtl"'; }?> data-item-slider="ot_slider_<?php echo esc_attr( $this->get_id() ); ?>">
				...
				<?php if ( ! empty( $settings['testi_slider'] ) ) : foreach ( $settings['testi_slider'] as $testi ) : 
					...
					if( $testi['timage']['id'] ){
						...
						$image_html = '<img src="' . esc_attr( $testi['timage']['url'] ) . '" alt="' . esc_attr( $testi['title'] ) . '">';
					}
					?>
				...
				<?php if( $arrows  ){ ?>
				<!-- Add Arrows -->
				<div class="octf-swiper-button-next" data-slider="ot_slider_<?php echo esc_attr( $this->get_id() ); ?>"><i class="ot-flaticon-right-arrow"></i></div>
				<div class="octf-swiper-button-prev" data-slider="ot_slider_<?php echo esc_attr( $this->get_id() ); ?>"><i class="ot-flaticon-left-arrow"></i></div>
				<?php } ?>
				<?php if( $dots ){ ?>
				<!-- Add Dots -->
				<div class="octf-swiper-pagination" data-slider="ot_slider_<?php echo esc_attr( $this->get_id() ); ?>"></div>
				<?php } ?>
			</div>				
	    </div>
...
Plugin::instance()->widgets_manager->register( new Theratio_Testimonials() );
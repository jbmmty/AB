...
<nav class="wc-pagination">
	<?php
		$pagination = array( // WPCS: XSS ok.
			...
			'total'        => $total,
			'prev_text' => is_rtl() ? '<i class="ot-flaticon-right-arrow"></i>' : '<i class="ot-flaticon-left-arrow"></i>',
			'next_text' => is_rtl() ? '<i class="ot-flaticon-left-arrow"></i>' : '<i class="ot-flaticon-right-arrow"></i>',
			'type'         => 'list',
			'end_size'     => 3,
			'mid_size'     => 3,
		);
